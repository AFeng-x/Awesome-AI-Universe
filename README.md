...
| ------------ | ------- | -------- |
| ChatGPT      | <ul><li>[official website](https://chat.openai.com/chat)</li><li>[GPT4](https://openai.com/product/gpt-4)</li></ul>  | - eng: The chatbot based on GPT proposed by open AI. ChatGPT Plus uses the GPT4 engine, which needs to be subscribed to use. <br> - ch: 由Open AI 基于GPT技术开发的聊天机器人，chatgpt plus 版本采用的是GPT4引擎，需要订阅购买才能使用。 |
